...
export const Route = createFileRoute('/api/stats/markdown')({
  server: {
    handlers: {
      GET: async () => {
        try {
          ...
          const readingStats = stats[0] || {
            totalBooksRead: 0, totalPagesRead: 0, totalBooksReading: 0,
            totalBooksWantToRead: 0, averageRating: 0, booksReadThisYear: 0,
            booksReadThisMonth: 0, pagesReadThisYear: 0, pagesReadThisMonth: 0,
          }
