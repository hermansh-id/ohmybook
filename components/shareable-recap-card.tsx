    ...
    return (
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 10, height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "6rem 5rem" }}>
          ...
          {/* Stats Grid */}
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2.5rem", width: "100%", maxWidth: "1000px", marginBottom: "3rem" }}>
            {/* Books */}
            <div style={{ position: "relative" }}>
              ...
              <div style={{ position: "relative", background: "linear-gradient(135deg, rgba(255,255,255,0.15), rgba(255,255,255,0.05))", backdropFilter: "blur(20px) saturate(180%)", borderRadius: "2rem", padding: "3rem 2.5rem", border: "1px solid rgba(255,255,255,0.25)", textAlign: "center", boxShadow: "0 8px 32px 0 rgba(0, 0, 0, 0.37)" }}>
                <div style={{ fontSize: "8rem", fontWeight: 700, color: "white", marginBottom: "1rem", textShadow: "0 4px 30px rgba(0, 122, 255, 0.6)", letterSpacing: "-0.02em" }}>
                  {data.booksFinished}
                </div>
                <p style={{ fontSize: "3rem", fontWeight: 600, color: "rgba(255,255,255,0.95)", letterSpacing: "0.02em" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <div style={{ position: "relative", background: "linear-gradient(135deg, rgba(255,255,255,0.15), rgba(255,255,255,0.05))", backdropFilter: "blur(20px) saturate(180%)", borderRadius: "2rem", padding: "3rem 2.5rem", border: "1px solid rgba(255,255,255,0.25)", textAlign: "center", boxShadow: "0 8px 32px 0 rgba(0, 0, 0, 0.37)" }}>
                <div style={{ fontSize: "8rem", fontWeight: 700, color: "white", marginBottom: "1rem", textShadow: "0 4px 30px rgba(88, 86, 214, 0.6)", letterSpacing: "-0.02em" }}>
                  {data.pagesRead.toLocaleString()}
                </div>
                <p style={{ fontSize: "3rem", fontWeight: 600, color: "rgba(255,255,255,0.95)", letterSpacing: "0.02em" }}>Pages</p>
              </div>
            </div>
          </div>
            ...
            {data.topGenre && (
              <div style={{ position: "relative" }}>
                ...
                <div style={{ position: "relative", background: "linear-gradient(135deg, rgba(255,255,255,0.12), rgba(255,255,255,0.04))", backdropFilter: "blur(16px) saturate(180%)", borderRadius: "1.5rem", padding: "2rem 2.5rem", border: "1px solid rgba(255,255,255,0.2)", display: "flex", alignItems: "center", gap: "2rem", boxShadow: "0 4px 24px 0 rgba(0, 0, 0, 0.25)" }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <p style={{ fontSize: "2.25rem", color: "rgba(255,255,255,0.75)", fontWeight: 600, marginBottom: "0.5rem", letterSpacing: "0.01em" }}>Favorite Genre</p>
                    <p style={{ fontSize: "4.5rem", fontWeight: 700, color: "white", textShadow: "0 4px 20px rgba(10, 132, 255, 0.4)", letterSpacing: "-0.01em" }}>
                      {data.topGenre}
                    </p>
                  </div>
                </div>
            ...
            {data.topRatedBook && (
              <div style={{ position: "relative" }}>
                ...
                <div style={{ position: "relative", background: "linear-gradient(135deg, rgba(255,255,255,0.12), rgba(255,255,255,0.04))", backdropFilter: "blur(16px) saturate(180%)", borderRadius: "1.5rem", padding: "2rem 2.5rem", border: "1px solid rgba(255,255,255,0.2)", display: "flex", alignItems: "center", gap: "2rem", boxShadow: "0 4px 24px 0 rgba(0, 0, 0, 0.25)" }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <p style={{ fontSize: "2.25rem", color: "rgba(255,255,255,0.75)", fontWeight: 600, marginBottom: "0.5rem", letterSpacing: "0.01em" }}>Top Rated</p>
                    <p style={{ fontSize: "3.5rem", fontWeight: 700, color: "white", marginBottom: "0.5rem", textShadow: "0 4px 20px rgba(255, 159, 10, 0.4)", letterSpacing: "-0.01em" }}>
                      {data.topRatedBook.title}
                    </p>
                    <div style={{ display: "flex", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
                      <p style={{ fontSize: "2.25rem", color: "rgba(255,255,255,0.85)", fontWeight: 500 }}>by {data.topRatedBook.authors}</p>
                      <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", background: "rgba(255,159,10,0.25)", padding: "0.75rem 1.5rem", borderRadius: "9999px", border: "1px solid rgba(255,159,10,0.3)" }}>
                        <svg width="28" height="28" viewBox="0 0 24 24" fill="#ff9f0a" stroke="none">
                          <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                        </svg>
                        <span style={{ fontSize: "2.5rem", fontWeight: 700, color: "white" }}>{data.topRatedBook.rating}</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {data.fastestBook && (
              <div style={{ position: "relative" }}>
                ...
                <div style={{ position: "relative", background: "linear-gradient(135deg, rgba(255,255,255,0.12), rgba(255,255,255,0.04))", backdropFilter: "blur(16px) saturate(180%)", borderRadius: "1.5rem", padding: "2rem 2.5rem", border: "1px solid rgba(255,255,255,0.2)", display: "flex", alignItems: "center", gap: "2rem", boxShadow: "0 4px 24px 0 rgba(0, 0, 0, 0.25)" }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <p style={{ fontSize: "2.25rem", color: "rgba(255,255,255,0.75)", fontWeight: 600, marginBottom: "0.5rem", letterSpacing: "0.01em" }}>Fastest Read</p>
                    <p style={{ fontSize: "3.5rem", fontWeight: 700, color: "white", marginBottom: "0.5rem", textShadow: "0 4px 20px rgba(48, 209, 88, 0.4)", letterSpacing: "-0.01em" }}>
                      {data.fastestBook.title}
                    </p>
                    <p style={{ fontSize: "2.5rem", color: "rgba(255,255,255,0.85)", fontWeight: 600 }}>
          ...
          <div style={{ marginTop: "4rem", textAlign: "center" }}>
            <p style={{ fontSize: "2.75rem", color: "rgba(255,255,255,0.5)", fontWeight: 500, display: "flex", alignItems: "center", gap: "1rem", justifyContent: "center", letterSpacing: "0.02em" }}>
