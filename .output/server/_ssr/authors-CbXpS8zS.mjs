...
import { Q as ArrowUpDown, Z as ArrowUp, f as Star, i as User, tt as ArrowDown } from "../_libs/lucide-react.mjs";
import { t as Input } from "./input-BO5Hu60S.mjs";
import { n as getAuthorsWithStatsAction } from "./authors-CvrsKKX8.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/authors-CbXpS8zS.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var authorsQueryKey = ["authors"];
function useAuthors() {
	return useQuery({
		...
		columns: (0, import_react.useMemo)(() => [
			columnHelper.accessor((row) => row.author.name, {
				...
				header: ({ column }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
					...
					children: ["Author", column.getIsSorted() === "asc" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUp, { className: "ml-1 h-3 w-3" }) : column.getIsSorted() === "desc" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowDown, { className: "ml-1 h-3 w-3" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpDown, { className: "ml-1 h-3 w-3" })]
				}),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: "Browse authors in your collection"
			})] }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-sm text-muted-foreground",
							children: "Avg Books/Author"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-2xl font-bold",
							children: authors.length > 0 ? (totalBooks / authors.length).toFixed(1) : 0
						})]
					}) })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, { children: "All Authors" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
					placeholder: "Search authors...",
					value: globalFilter,
					onChange: (e) => setGlobalFilter(e.target.value),
					className: "max-w-xs"
				})]
			}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, { children: authors.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-col items-center justify-center py-12 text-center",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(User, { className: "mb-4 h-12 w-12 text-muted-foreground" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-muted-foreground",
						children: "Add books to see authors"
					})
				]
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "text-sm text-muted-foreground",
					children: [table.getFilteredRowModel().rows.length, " author(s)"]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
var SplitComponent = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthorsClient, {});
//#endregion
