...
import { n as export_types, t as cs } from "./neondatabase__serverless.mjs";
...
//#endregion
//#region node_modules/drizzle-orm/pg-core/checks.js
...
//#endregion
//#region node_modules/drizzle-orm/neon-http/session.js
var rawQueryConfig = {
	arrayMode: false,
	fullResults: true
};
...
//#endregion
//#region node_modules/drizzle-orm/neon-http/driver.js
...
function wrap(target, token, cb, deep) {
	return new Proxy(target, { get(target2, p) {
		...
		return new Proxy(element, { apply(target3, thisArg, argArray) {
...
var NeonHttpDatabase = class extends PgDatabase {
	...
	$withAuth(token) {
		...
		return wrap(this, token, (target, p, res) => {
			if (p === "with") return wrap(res, token, (_, __, res2) => res2);
			return res;
		});
	}
	async batch(batch) {
...
function drizzle(...params) {
	if (typeof params[0] === "string") return construct(cs(params[0]), params[1]);
	if (isConfig(params[0])) {
		const { connection, client, ...drizzleConfig } = params[0];
		if (client) return construct(client, drizzleConfig);
		if (typeof connection === "object") {
			const { connectionString, ...options } = connection;
			return construct(cs(connectionString, options), drizzleConfig);
		}
		return construct(cs(connection), drizzleConfig);
	}
...
//#endregion
export { boolean as A, varchar as C, numeric as D, serial as E, unique as M, integer as O, pgTable as S, text as T, notInArray as _, desc as a, index as b, gt as c, inArray as d, isNull as f, ne as g, lte as h, asc as i, sql as j, date as k, gte as l, lt as m, drizzle as n, and as o, like as p, count as r, eq as s, drizzle_orm_exports as t, ilike as u, or as v, timestamp as w, check as x, primaryKey as y };
